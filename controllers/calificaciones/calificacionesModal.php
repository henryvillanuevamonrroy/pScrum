...
<div class="modal fade" id="editCalModal" tabindex="-1" role="dialog">
                ...
                <div class="div-result">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="Info1">
                            <form action="../../controllers/usuarios/editUser.php" method="POST" id="editUserForm" class="form-horizontal">
