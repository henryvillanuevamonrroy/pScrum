    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-edit"></i> Editar Estudiante</h4>
            </div>
                ...
                <div class="div-result">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="Info1">
                            <form action="../../controllers/usuarios/editUser_estudiante.php" method="POST" id="editUserForm" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                           <select class="form-control" id="editGrado" name="editGrado" style="width: 100%;" required>
                                               <option value="">Seleccionar</option>
                                               <option value="16">6to de primaria</option>
                                               <option value="21">1ro de secundaria</option>
                                               <option value="22">2do de secundaria</option>
                                               <option value="23">3ro de sucundaria</option>
                                               <option value="24">4to de secundaria</option>
                                               <option value="25">5to de secundaria</option>
                                           </select>
                                        <!--input type="text" class="form-control" id="editSerie" placeholder="Serie" name="editSerie" autocomplete="off" required-->
                                    </div>
                                </div> <!-- /form-group5-->   
