...
<div class="row">
    <div class="col-sm-12 table-responsive">
       ...
       <table  style="width: 20%;text-align:center;" class="table  table-hover table-condensed table-bordered">
            ...
            while ($ver = mysqli_fetch_row($result)) {
                ...
                <tr>
                    <td><input id="alumno<?php echo $contador ?>" name="alumno<?php echo $contador ?>" type="text" maxlength="40" size="40" value="<?php echo $ver[2] . " " . $ver[1] ?>" readonly=""></td>
